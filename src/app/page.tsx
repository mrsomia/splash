        ...
        <div className="grid gap-6 items-center">
          <div className="flex flex-col justify-center space-y-8 text-center">
            <div className="space-y-2">
              <h1 className="py-1 text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-500">
                Splash Tournament Organiser
              </h1>
              <p className="max-w-[600px] text-zinc-200 md:text-xl dark:text-zinc-100 mx-auto">
                Oraganise your next bar tournament with ease
              </p>
            </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="flex flex-col items-center space-y-2 border-gray-800 p-4 rounded-lg">
                  ...
                  <p className="text-zinc-200 dark:text-zinc-100">
                    A Randomised schedule, that works with uneven numbers. So
                    you don&#39;t need to have 16 or 32 teams exactly.
                  </p>
                </div>
                <div className="flex flex-col items-center space-y-2 border-gray-800 p-4 rounded-lg">
                  <div className="p-2 rounded-full">
                  ...
                  <p className="text-zinc-200 dark:text-zinc-100">
                    Allow all players and teams to track the tournament
                    themselves.
                  </p>
                </div>
                <div className="flex flex-col items-center space-y-2 border-gray-800 p-4 rounded-lg">
                  ...
                  <p className="text-zinc-200 dark:text-zinc-100">
                    COMING SOON: Notifications to call teams over for their next
                    game
                  </p>
                </div>
                {/* <div className="flex flex-col items-center space-y-2 border-gray-800 p-4 rounded-lg"> */}
